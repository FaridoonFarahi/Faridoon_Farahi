...
We expect a formatted and complete Jupyter Notebook that accomplishes the following:
...
## Necessary Deliverables / Submission
 ...
 Materials must be presented in a Jupyter Notebook stored within a repository on your personal (*not* GA) GitHub. Please submit a link to this repository by the due date through [Google Classroom](https://classroom.google.com/).
