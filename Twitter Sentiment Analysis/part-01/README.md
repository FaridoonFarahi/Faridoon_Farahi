...
**You do not need to prepare slides for your talk.  Just be prepared to discuss it with your colleagues.** Having said that, **please submit a written document** with your proposal on Google Classroom as usual! (It can be your slides if you prefer to prepare slides, or a Jupyter Notebook, a markdown file, a text file, Google Document, etc.)
...
> Note that you *do not need to* prepare slides for your talk, but you may. This will be a verbal pitch with discussion.
...
- [Sample Data Sources for Students](https://git.generalassemb.ly/DSIR-1019/course-info/wiki/Sample-Data-Sources-for-Students)
